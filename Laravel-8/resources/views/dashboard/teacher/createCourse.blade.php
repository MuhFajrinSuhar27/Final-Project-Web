<x-layout3>
    ...
    <main class="flex-1 ml-0 lg:ml-64  mt-[-38rem]"> <!-- Adjusted margin top -->
        <div class="container mx-auto px-4 max-w-3xl"> <!-- Reduced max width -->
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                ...
                <div class="relative h-32 bg-gradient-to-r from-indigo-600 to-purple-600 flex items-center px-8">
                    ...
                    <div class="flex items-center space-x-4 relative z-10">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-white">Course Baru</h2>
                            <p class="text-indigo-100 text-sm">Mulai berbagi pengetahuan Anda</p>
                        </div>
                    </div>
                </div>
